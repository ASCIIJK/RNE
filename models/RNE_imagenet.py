...
from models.BaseNet import RNEbaseNet
...
class RNE(object):
    ...
    def init_train(self, datamanger):
        ...
        print("feature_mean_shape is {}".format(self.feature_mean.shape))
    ...
    def increment_train(self):
        ...
        print("feature_mean_shape is {}".format(self.feature_mean.shape))
        print("feature_var_shape is {}".format(self.feature_var.shape))
            ...
            for i, (_, inputs, targets) in enumerate(train_loader):
                ...
                if self.cur_task == 0:
                    ...
                    if mask_old.count(False) > 0:
                        beta = 0.1 + 1.5 * epoch / self.epochs
                        gamma = mask_old.count(True) / mask_old.count(False) * beta
                    else:
                        gamma = 0.001
