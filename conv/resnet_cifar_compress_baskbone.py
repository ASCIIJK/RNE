...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # self.conv_layer0 = nn.Conv2d(64, 8, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv_layer1 = nn.Conv2d(64, 16, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv_layer2 = nn.Conv2d(128, 32, kernel_size=3, stride=1, padding=1, bias=False)
        self.conv_layer3 = nn.Conv2d(256, 64, kernel_size=1, stride=1, bias=False)
        self.conv_layer4 = nn.Conv2d(512, 128, kernel_size=1, stride=1, bias=False)
    ...
    def _forward_impl(self, x, fmaps):
        if fmaps is None:
            ...
            return {
                'fmaps': [self.conv_layer1(x_1), self.conv_layer2(x_2), self.conv_layer3(x_3),
                          self.conv_layer4(x_4)],
                'features': features
            }
        else:
            # See note [TorchScript super()]
